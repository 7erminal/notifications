...
type Categories struct {
	...
	CategoryName string    `orm:"column(category_name);size(40)"`
	...
	Icon         string    `orm:"column(icon);size(400);null"`
...
// Id doesn't exist
func GetCategoriesById(id int) (v *Categories, err error) {
	o := orm.NewOrm()
	v = &Categories{Id: id}
...
func DeleteCategories(id int) (err error) {
	o := orm.NewOrm()
	v := Categories{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
