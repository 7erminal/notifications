...
func (c *ServiceController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddService(&v); err == nil {
...
func (c *ServiceController) GetOne() {
	...
	v, err := models.GetServiceById(id)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = v
...
func (c *ServiceController) GetAll() {
	...
	l, err := models.GetAllService(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
